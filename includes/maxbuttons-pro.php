...
<div id="maxbuttons">
	<div class="wrap">
		<div class="icon32">
			<a href="https://maxbuttons.com" target="_blank"><img src="<?php echo maxButtons::get_plugin_url() ?>images/mb-32.png" alt="MaxButtons" /></a>
		</div>
		...
		<div class="pro-offer">
			...
			<div class="button-packs">
				<div class="pack">
					<a href="https://maxbuttons.com/shop/e-commerce-buttons/?ref=mbfree" target="_blank"><img src="<?php echo maxButtons::get_plugin_url() ?>images/button-pack-e-commerce-buttons.png" alt="E-Commerce Buttons" border="0" /></a>
					<br />
					<a href="http://maxbuttons.com/shop/e-commerce-buttons/?ref=mbfree" target="_blank"><?php _e('E-Commerce Buttons', 'maxbuttons') ?></a>
				</div>
				<div class="pack">
					<a href="https://maxbuttons.com/shop/colored-round-social-icons-1/?ref=mbfree" target="_blank"><img src="<?php echo maxButtons::get_plugin_url() ?>images/button-pack-colored-round-social-icons-1.png" alt="Colored Round Social Icons 1" border="0" /></a>
					<br />
				...
				<div class="pack">
					<a href="https://maxbuttons.com/shop/chrome-icons/?ref=mbfree" target="_blank"><img src="<?php echo maxButtons::get_plugin_url() ?>images/button-pack-chrome-icons.png" alt="Chrome Icons" border="0" /></a>
					<br />
				...
				<div class="pack">
					<a href="https://maxbuttons.com/shop/pace/?ref=mbfree" target="_blank"><img src="<?php echo maxButtons::get_plugin_url() ?>images/button-pack-pace.png" alt="Pace" border="0" /></a>
					<br />
					<a href="https://maxbuttons.com/shop/pace/?ref=mbfree" target="_blank"><?php _e('Pace', 'maxbuttons') ?></a>
				</div>
				<div class="pack">
					<a href="https://maxbuttons.com/shop/social-sign-in/?ref=mbfree" target="_blank"><img src="<?php echo maxButtons::get_plugin_url() ?>images/button-pack-social-sign-in.png" alt="Social Sign-In" border="0" /></a>
					<br />
